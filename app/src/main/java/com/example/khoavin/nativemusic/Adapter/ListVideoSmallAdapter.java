...
public class ListVideoSmallAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            holder.videoName = (TextView)listView.findViewById(R.id.video_name_small);
            holder.videoImage = (ImageView)listView.findViewById(R.id.video_image_small);
            holder.listenerCount = (TextView)listView.findViewById(R.id.video_listener_count_small);
            holder.singer = (TextView)listView.findViewById(R.id.video_singer_small);
