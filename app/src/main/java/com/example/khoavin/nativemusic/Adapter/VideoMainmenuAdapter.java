...
public class VideoMainmenuAdapter extends BaseAdapter {
    private Context mContext;

    private Video[] mVideoSource;

    public VideoMainmenuAdapter(Context c, Video[] videoSource){
        mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            listView = inflater.inflate(R.layout.single_video_mainmenu, parent, false);
